<?php
    // Ellenőrzi, hogy érkezett e paraméterben id
    if (isset($_GET['id'])) {
        // Lekéri a felhasználókat
        $users = get_data($api_url);
        // Megkeresi a módosítani kívánt felhasznélót az összes közül
    ...
    // Amennyiben a http kérés POST, a megfelelő adat módosítása az api url-en, az új értékek beállítása
...
<div class="background"></div>
    ...
    <main class="col-lg-6 col-10">
        <!-- Form az módosítani kívánt felhasználó adatainak megadásához bootstrap validálással -->
