    ...
    <main class="col-lg-6 col-10">
        ...
        <form class="form-control p-4 needs-validation" method="POST" action="service/update.php" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $edited_user['name']; ?>"
                    pattern="^[A-ZÜŰÖŐÓÚÁÉÍ][a-zöőüűóúéáíA-ZÜŰÖŐÓÚÁÉÍ]{3,}(?: [A-ZÜŰÖŐÓÚÁÉÍ][a-zöőüűóúéáíA-ZÜŰÖŐÓÚÁÉÍ]*){0,2}$" required>
                <div class="invalid-feedback">Please enter a valid name.</div>
            </div>
            <div class="mb-3">
                <label for="emailAddress" class="form-label">Email address</label>
                <input type="email" class="form-control" id="emailAddress" name="emailAddress" aria-describedby="emailHelp" value="<?php echo $edited_user['emailAddress']; ?>" required>
                <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                <div class="invalid-feedback">Please enter a valid email address.</div>
            </div>
            <div class="mb-4">
                <label for="address" class="form-label">Address</label>
                <input type="text" class="form-control" id="address" name="address" value="<?php echo $edited_user['address']; ?>" required>
                <div class="invalid-feedback">Please enter an address.</div>
            </div>
            <div class="d-flex flex-column align-items-center justify-content-center">
                <div class="mb-4 form-check">
                    <input type="checkbox" class="form-check-input" id="active" name="active" <?php if ($edited_user['active']) echo 'checked'; ?>>
